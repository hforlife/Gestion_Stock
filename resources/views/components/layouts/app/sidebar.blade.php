    ...
    <flux:sidebar sticky stashable class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
        ...
        <flux:navlist variant="outline">
            ...
            <flux:navlist.item icon="shopping-bag" :href="route('pos')" :current="request()->routeIs('pos')"
                               wire:navigate>{{ __('Point Of Sales') }}</flux:navlist.item>
            {{-- Management --}}
            <flux:navlist.group :heading="__('Management')" class="grid">
                <flux:navlist.item icon="user-group" :href="route('customers.index')" :current="request()->routeIs('customers.index')"
                    wire:navigate>{{ __('Manage Customer') }}</flux:navlist.item>
                <flux:navlist.item icon="credit-card" :href="route('payment.method.index')" :current="request()->routeIs('payment.method.index')"
            ...
            <flux:navlist.group :heading="__('Inventory Management')" class="grid">
                <flux:navlist.item icon="queue-list" :href="route('items.index')" :current="request()->routeIs('items.index')"
                                   wire:navigate>{{ __('Items') }}</flux:navlist.item>
                <flux:navlist.item icon="cube" :href="route('inventories.index')" :current="request()->routeIs('inventories.index')"
                                   wire:navigate>{{ __('Inventory') }}</flux:navlist.item>
            </flux:navlist.group>

            {{-- Sales --}}
            <flux:navlist.group :heading="__('Sales')" class="grid">
                <flux:navlist.item icon="shopping-cart" :href="route('sales.index')" :current="request()->routeIs('sales.index')"
